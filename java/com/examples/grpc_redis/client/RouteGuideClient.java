...
public class RouteGuideClient {
  ...
  public void getFeature(int lat, int lon) {
    ...
    if (RouteGuideUtil.validate(feature)) {
   ...
   * server.
   */
  public void recordRoute(Iterator<Feature> features, int numPoints) throws InterruptedException {
    info("*** RecordRoute");
    ...
    try {
      ...
      for (int i = 0; i < numPoints && features.hasNext(); ++i) {
        Point point = features.next().getLocation();
